...
public class CreateData {
	...
	public static GrafoLista createM29() {
		...
		VerticeTO c10 = new VerticeTO();
		c10.setX(23616.6667d);
		c10.setY(15866.666d);
		c10.setNome("c10");
		c10.setId(idVertices++);
		
		VerticeTO c11 = new VerticeTO();
		c11.setX(23700.0000d);
		c11.setY(15933.3333d);
		c11.setNome("c11");
		c11.setId(idVertices++);
		
		VerticeTO c12 = new VerticeTO();
		c12.setX(23883.3333d);
		c12.setY(14533.3333d);
		c12.setNome("c12");
		c12.setId(idVertices++);
		
		VerticeTO c13 = new VerticeTO();
		c13.setX(24166.6667d);
		c13.setY(13250.0000d);
		c13.setNome("c13");
		c13.setId(idVertices++);
		
		VerticeTO c14 = new VerticeTO();
		c14.setX(25149.1667d);
		c14.setY(12365.8333d);
		c14.setNome("c14");
		c14.setId(idVertices++);

		VerticeTO c15 = new VerticeTO();
		c15.setX(26133.3333d);
		c15.setY(14500.0000d);
		c15.setNome("c15");
		c15.setId(idVertices++);
		
		VerticeTO c16 = new VerticeTO();
		c16.setX(26150.0000d);
		c16.setY(10550.0000d);
		c16.setNome("c16");
		c16.setId(idVertices++);
		
		VerticeTO c17 = new VerticeTO();
		c17.setX(26283.3333d);
		c17.setY(12766.6667d);
		c17.setNome("c17");
		c17.setId(idVertices++);
		
		VerticeTO c18 = new VerticeTO();
		c18.setX(26433.3333d);
		c18.setY(13433.3333d);
		c18.setNome("c18");
		c18.setId(idVertices++);
		
		VerticeTO c19 = new VerticeTO();
		c19.setX(26550.0000d);
		c19.setY(13850.0000d);
		c19.setNome("c19");
		c19.setId(idVertices++);
		
		VerticeTO c20 = new VerticeTO();
		c20.setX(26733.3333d);
		c20.setY(11683.3333d);
		c20.setNome("c20");
		c20.setId(idVertices++);
		
		VerticeTO c21 = new VerticeTO();
		c21.setX(27026.1111d);
		c21.setY(13051.9444d);
		c21.setNome("c21");
		c21.setId(idVertices++);
		
		VerticeTO c22 = new VerticeTO();
		c22.setX(27096.1111d);
		c22.setY(13415.8333d);
		c22.setNome("c22");
		c22.setId(idVertices++);
		
		VerticeTO c23 = new VerticeTO();
		c23.setX(27153.6111d);
		c23.setY(13203.3333d);
		c23.setNome("c23");
		c23.setId(idVertices++);
		
		VerticeTO c24 = new VerticeTO();
		c24.setX(27166.6667d);
		c24.setY(9833.3333d);
		c24.setNome("c24");
		c24.setId(idVertices++);
		
		VerticeTO c25 = new VerticeTO();
		c25.setX(27233.3333d);
		c25.setY(10450.0000d);
		c25.setNome("c25");
		c25.setId(idVertices++);
		
		VerticeTO c26 = new VerticeTO();
		c26.setX(27233.3333d);
		c26.setY(11783.3333d);
		c26.setNome("c26");
		c26.setId(idVertices++);
		
		VerticeTO c27 = new VerticeTO();
		c27.setX(27266.6667d);
		c27.setY(10383.3333d);
		c27.setNome("c27");
		c27.setId(idVertices++);
		
		VerticeTO c28 = new VerticeTO();
		c28.setX(27433.3333d);
		c28.setY(12400.0000d);
		c28.setNome("c28");
		c28.setId(idVertices++);
		
		VerticeTO c29 = new VerticeTO();
		c29.setX(27462.5000d);
		c29.setY(12992.2222d);
		c29.setNome("c29");
	...
	public static GrafoLista createM38() {

		GrafoLista grafo = new GrafoLista();
		grafo.setId(idGrafo++);
		grafo.setNomeGrafo("M38");
		
		try {
			FileInputStream fstream = 
						new FileInputStream("/Users/miller/Mestrado/algoritmo-genetico/caxeiro-viajante/src/main/java/m39.txt");
			...
			while ((strLine = br.readLine()) != null) {
				...
				VerticeTO vo = new VerticeTO();
				vo.setId(idVertices++);
				vo.setNome("c"+ tokens[0]);
				vo.setX(Double.valueOf(tokens[1]));
				vo.setY(Double.valueOf(tokens[2]));
